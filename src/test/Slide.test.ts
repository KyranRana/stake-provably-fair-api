import verifySlide from "../main/Slide"
...
`('verifySlide - verifies slide game given multiplayer game seed $gameSeed and provides hmac used in process', (testcase: TestCaseData) => {
  expect(verifySlide(testcase.gameSeed)).toStrictEqual(testcase.expected)
})